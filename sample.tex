...
% 论文的英文标题，不可换行
\englishtitle{A Research on Cell Clustering and Defect Detection in Spreadsheets}
% 论文作者姓名的拼音
\englishauthor{LI Da}
% 导师姓名职称的英文
...
\englishabstracttitlea{A Research on Cell Clustering and Defect Detection}
% 设置英文摘要页面的论文标题及副标题的第二行。
% 此属性可选，其默认值为空白
\englishabstracttitleb{in Spreadsheets}
