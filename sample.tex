\documentclass[master, winfonts, twoside]{njuthesis}
...
% 单行论文标题，不可换行
% \title{电子表格的单元格聚类与缺陷检测优化技术研究}
\titlea{电子表格的单元格聚类与缺陷检测}
\titleb{优化技术研究}
% 论文作者姓名
\author{李达}
% \author{匿名}
...
% 论文的英文标题，不可换行
\englishtitle{A Research on Spreadsheet Cell Clustering Refinement for Effective Defect Detection}
% 论文作者姓名的拼音
\englishauthor{LI Da}
% \englishauthor{anonymous}
% 导师姓名职称的英文
\englishsupervisor{Professor LU Jian, Professor XU Chang}
% \englishsupervisor{anonymous}
% 论文作者学科与专业的英文名
...
\englishabstracttitlea{A Research on Spreadsheet Cell Clustering Refinement for}
% 设置英文摘要页面的论文标题及副标题的第二行。
% 此属性可选，其默认值为空白
\englishabstracttitleb{Effective Defect Detection}
